...
resource "azurerm_postgresql_flexible_server" "postgresql_flexible" {
  ...
  delegated_subnet_id = azurerm_subnet.postgresql_flexible_subnet.id
  ...
  storage_mb             = 4194304
  # commented because of the open issue https://github.com/hashicorp/terraform-provider-azurerm/issues/21522
